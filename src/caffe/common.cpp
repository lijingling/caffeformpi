...
void SetLogDir(const char* program_name, const char* log_dir) {
  ...
  ::google::SetLogDestination(google::GLOG_WARNING, log_dir);
  ::google::SetLogDestination(google::GLOG_ERROR, log_dir);
...
void GlobalInit(int* pargc, char*** pargv) {
  ...
  MPI_CHECK(MPI_Init_thread(pargc, pargv, MPI_THREAD_MULTIPLE, &provided_thread_support));
