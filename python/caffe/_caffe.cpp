...
void set_log_dir(string logdir) {
  SetLogDir("pycaffe", logdir.c_str());
}
...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  int argc = 1;
  char* programe_name = const_cast<char*>("pycaffe");
  char ** argv = &(programe_name);
  ...
  bp::def("set_log_dir", &set_log_dir);
